...
function AvatarUpload({
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div>
        <input ref={ref} type="file" accept=".heic,.heif,image/heic,image/heif,image/jpeg,image/png,image/webp" style={{ position: 'absolute', opacity: 0, width: 0, height: 0 }} onChange={onFileChange} aria-label="Upload profile photo" />
        <button
          type="button"
