...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "art1_body": {
        ...
        "pl": (
            "1. Niniejszy Regulamin dla Dostawców Usług (Regulamin Dostawców) określa zasady i warunki korzystania z platformy Nevumo przez użytkowników rejestrujących się jako dostawcy usług (Dostawca).\n\n"
            "2. Nevumo prowadzi internetową platformę pośrednictwa usługowego dostępną pod adresem nevumo.com oraz jej poddomenami językowymi (Platforma), która umożliwia Dostawcom prezentowanie swoich usług oraz łączy ich z klientami poszukującymi tych usług (Klienci).\n\n"
            ...
            "7. Zabrania się dostarczania przez Dostawców treści o charakterze bezprawnym na Platformie."
        ),
        "bg": (
            ...
            "1.7 На Доставчиците е забранено да публикуват или предоставят незаконно съдържание на Платформата."
        ),
        "cs": (
            ...
            "1.7 Poskytovatelům je zakázáno předkládat nebo zveřejňovat nezákonný obsah na Platformě."
        ),
        "de": (
            ...
            "1.7 Es ist Anbietern untersagt, rechtswidrige Inhalte auf der Plattform einzureichen oder zu veröffentlichen."
        ),
        "fr": (
            ...
            "1.7 Les Prestataires ont l'interdiction de soumettre ou de publier des contenus illicites sur la Plateforme."
        ),
        "es": (
            ...
            "1.7 Los Proveedores tienen prohibido enviar o publicar contenido ilícito en la Plataforma."
        ),
        "it": (
            ...
            "1.7 Ai Fornitori è vietato inviare o pubblicare contenuti illeciti sulla Piattaforma."
        ),
        "nl": (
            ...
            "1.7 Het is Aanbieders verboden onrechtmatige inhoud in te dienen of te publiceren op het Platform."
        ),
        "pt": (
            ...
            "1.7 É proibido aos Fornecedores enviar ou publicar conteúdo ilícito na Plataforma."
        ),
        "pt-PT": (
            ...
            "1.6 Estes Termos do prestador foram elaborados em conformidade com o Regulamento (UE) 2019/1150 relativo a promocao da equidade e da transparencia para os utilizadores profissionais dos servicos de intermediacao em linha (Regulamento P2B).\n\n"
            "1.7 É proibido aos Prestadores enviar ou publicar conteúdo ilícito na Plataforma."
        ),
        "ro": (
            ...
            "1.7 Furnizorii au interdicția de a trimite sau publica conținut ilegal pe Platformă."
        ),
        "ru": (
            ...
            "1.7 Поставщикам запрещено размещать или публиковать незаконный контент на Платформе."
        ),
        "uk": (
            ...
            "1.7 Постачальникам заборонено надсилати або публікувати незаконний вміст на Платформі."
        ),
        "da": (
            ...
            "1.7 Udbydere er forbudt at indsende eller offentliggøre ulovligt indhold på Platformen."
        ),
        "sv": (
            ...
            "1.7 Leverantörer är förbjudna att skicka in eller publicera olagligt innehåll på Plattformen."
        ),
        "no": (
            ...
            "1.7 Leverandører er forbudt å sende inn eller publisere ulovlig innhold på Plattformen."
        ),
        "fi": (
            ...
            "1.7 Palveluntarjoajien on kiellettyä lähettää tai julkaista laitonta sisältöä Alustalla."
        ),
        "et": (
            ...
            "1.7 Teenusepakkujatel on keelatud esitada või avaldada ebaseaduslikku sisu Platvormil."
        ),
        "lt": (
            ...
            "1.7 Tiekėjams draudžiama teikti ar skelbti neteisėtą turinį Platformoje."
        ),
        "lv": (
            ...
            "1.7 Pakalpojumu sniedzējiem ir aizliegts iesniegt vai publicēt nelikumīgu saturu Platformā."
        ),
        "hu": (
            ...
            "1.7 A Szolgáltatóknak tilos jogellenes tartalmat benyújtani vagy közzétenni a Platformon."
        ),
        "hr": (
            ...
            "1.7 Pružateljima usluga zabranjeno je dostavljati ili objavljivati nezakonit sadržaj na Platformi."
        ),
        "sk": (
            ...
            "1.7 Poskytovateľom je zakázané predkladať alebo zverejňovať nezákonný obsah na Platforme."
        ),
        "sl": (
            ...
            "1.7 Ponudnikom je prepovedano predložiti ali objaviti nezakonito vsebino na Platformi."
        ),
        "el": (
            ...
            "1.7 Απαγορεύεται στους Παρόχους να υποβάλλουν ή να δημοσιεύουν παράνομο περιεχόμενο στην Πλατφόρμα."
        ),
        "tr": (
            ...
            "1.7 Sağlayıcıların Platform'da yasadışı içerik göndermesi veya yayımlaması yasaktır."
        ),
        "ga": (
            ...
            "1.7 Tá cosc ar Sholáthróirí ábhar neamhdhleathach a chur isteach nó a fhoilsiú ar an Ardán."
        ),
        "is": (
            ...
            "1.7 Þjónustuaðilum er óheimilt að senda inn eða birta ólöglegt efni á Verkvangi."
        ),
        "lb": (
            ...
            "1.6 Dese Presser-Bedingungen goufen entspriechend der Verordnung (EU) 2019/1150 zur Foerderung vun Fairness a Transparenz fir Gescháftsbenotzer vun Online-Vermëttlungsservicer ausgeschafft (P2B-Verordnung).\n\n"
            "1.7 Et ass de Fournisseuren verbueden, illegal Inhalter op der Plattform anzebidden oder ze publizéieren."
        ),
        "mk": (
            ...
            "1.7 На Добавувачите им е забрането да доставуваат или објавуваат незаконита содржина на Платформата."
        ),
        "mt": (
            ...
            "1.7 Il-Fornituri huma pprojbiti milli jissottomettu jew jippubblikaw kontenut illegali fuq il-Pjattaforma."
        ),
        "sq": (
            ...
            "1.7 Ofruesve u ndalohet të dorëzojnë ose publikojnë përmbajtje të paligjshme në Platformë."
        ),
        "sr": (
            ...
            "1.7 Добављачима је забрањено да достављају или објављују незаконит садржај на Платформи."
        ),
    },
}
