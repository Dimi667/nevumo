...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "art6_body": {
        ...
        "pl": (
            "6.1 Platforma jest obecnie dla Dostawcow bezplatna w fazie startowej. Aktualny "
            "Cennik dostepny jest pod adresem nevumo.com/pricing.\n\n"
            "6.2 Nevumo zastrzega sobie prawo do wprowadzenia prowizji lub platnych "
            "funkcjonalnosci. O takim wprowadzeniu Dostawcy zostana poinformowani z co najmniej "
            "30-dniowym wyprzedzeniem w formie pisemnej przed data wejscia w zycie zmian.\n\n"
            "6.3 W przypadku wdrozenia obslugi platnosci za uslugi zawierane za posrednictwem "
            "Platformy, platnosci beda przetwarzane przez Stripe Inc. dzialajacy jako operator "
            "platnosci. Dla uzytkownikow w Polsce dostepne beda metody platnosci BLIK oraz "
            "Przelewy24.\n\n"
            "6.4 Nevumo nie przechowuje srodkow Klientow na wlasnych rachunkach. Wszelkie "
            "posrednictwo finansowe realizowane jest wylacznie za posrednictwem Stripe.\n\n"
            "6.5 Dostawcy ponosa wylaczna odpowiedzialnosc za wystawianie faktur, rozliczanie "
            "podatkow (VAT, podatek dochodowy) i przestrzeganie wszystkich obowiazujacych "
            "przepisow podatkowych w kraju prowadzenia dzialalnosci oraz w kraju swiadczenia "
            "uslug."
        ),
        "bg": (
