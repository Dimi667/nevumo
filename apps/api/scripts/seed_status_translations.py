...
PROVIDER_DASHBOARD_KEYS = [
    ...
    "status_btn_contacted", "status_btn_cancel", "status_cancelled"
]
...
RAW_PROVIDER_DATA = {
    "bg": "status_label_new=Нова, status_label_contacted=Осъществен контакт, status_label_done=Завършена, status_label_cancelled_by_provider=Отказана, status_label_cancelled_by_client=Клиентът отказа, status_btn_contacted=Осъществен контакт, status_btn_cancel=Откажи заявката, status_cancelled=Отказана",
    "cs": "status_label_new=Nová, status_label_contacted=Kontakt navázán, status_label_done=Dokončeno, status_label_cancelled_by_provider=Zrušeno, status_label_cancelled_by_client=Klient zrušil, status_btn_contacted=Kontakt navázán, status_btn_cancel=Zrušit žádost, status_cancelled=Zrušeno",
    "da": "status_label_new=Ny, status_label_contacted=Kontakt oprettet, status_label_done=Afsluttet, status_label_cancelled_by_provider=Annulleret, status_label_cancelled_by_client=Kunden annullerede, status_btn_contacted=Kontakt oprettet, status_btn_cancel=Annuller anmodning, status_cancelled=Annulleret",
    "de": "status_label_new=Neu, status_label_contacted=Kontakt hergestellt, status_label_done=Abgeschlossen, status_label_cancelled_by_provider=Storniert, status_label_cancelled_by_client=Kunde hat storniert, status_btn_contacted=Kontakt hergestellt, status_btn_cancel=Anfrage stornieren, status_cancelled=Storniert",
    "el": "status_label_new=Νέα, status_label_contacted=Έγινε επικοινωνία, status_label_done=Ολοκληρώθηκε, status_label_cancelled_by_provider=Ακυρώθηκε, status_label_cancelled_by_client=Ο πελάτης ακύρωσε, status_btn_contacted=Έγινε επικοινωνία, status_btn_cancel=Ακύρωση αιτήματος, status_cancelled=Ακυρώθηκε",
    "en": "status_label_new=New, status_label_contacted=Contact made, status_label_done=Completed, status_label_cancelled_by_provider=Cancelled, status_label_cancelled_by_client=Client cancelled, status_btn_contacted=Contact made, status_btn_cancel=Cancel request, status_cancelled=Cancelled",
    "es": "status_label_new=Nueva, status_label_contacted=Contacto realizado, status_label_done=Completada, status_label_cancelled_by_provider=Cancelada, status_label_cancelled_by_client=El cliente canceló, status_btn_contacted=Contacto realizado, status_btn_cancel=Cancelar solicitud, status_cancelled=Cancelado",
    "et": "status_label_new=Uus, status_label_contacted=Kontakt loodud, status_label_done=Lõpetatud, status_label_cancelled_by_provider=Tühistatud, status_label_cancelled_by_client=Klient tühistas, status_btn_contacted=Kontakt loodud, status_btn_cancel=Tühista taotlus, status_cancelled=Tühistatud",
    "fi": "status_label_new=Uusi, status_label_contacted=Yhteys otettu, status_label_done=Valmis, status_label_cancelled_by_provider=Peruutettu, status_label_cancelled_by_client=Asiakas peruutti, status_btn_contacted=Yhteys otettu, status_btn_cancel=Peruuta pyyntö, status_cancelled=Peruttu",
    "fr": "status_label_new=Nouvelle, status_label_contacted=Contact établi, status_label_done=Terminée, status_label_cancelled_by_provider=Annulée, status_label_cancelled_by_client=Le client a annulé, status_btn_contacted=Contact établi, status_btn_cancel=Annuler la demande, status_cancelled=Annulé",
    "ga": "status_label_new=Nua, status_label_contacted=Teagmháil déanta, status_label_done=Críochnaithe, status_label_cancelled_by_provider=Cealaithe, status_label_cancelled_by_client=Dhiúltaigh an cliant, status_btn_contacted=Teagmháil déanta, status_btn_cancel=Cealaigh an t-iarratas, status_cancelled=Cealaithe",
    "hr": "status_label_new=Nova, status_label_contacted=Kontakt ostvaren, status_label_done=Završeno, status_label_cancelled_by_provider=Otkazano, status_label_cancelled_by_client=Klijent je otkazao, status_btn_contacted=Kontakt ostvaren, status_btn_cancel=Otkaži zahtjev, status_cancelled=Otkazano",
    "hu": "status_label_new=Új, status_label_contacted=Kapcsolat felvéve, status_label_done=Befejezve, status_label_cancelled_by_provider=Lemondva, status_label_cancelled_by_client=Az ügyfél lemondta, status_btn_contacted=Kapcsolat felvéve, status_btn_cancel=Kérés visszavonása, status_cancelled=Törölve",
    "is": "status_label_new=Ný, status_label_contacted=Samband komið á, status_label_done=Lokið, status_label_cancelled_by_provider=Hætt við, status_label_cancelled_by_client=Viðskiptavinurinn hætti við, status_btn_contacted=Samband komið á, status_btn_cancel=Hætta við beiðni, status_cancelled=Hætt við",
    "it": "status_label_new=Nuova, status_label_contacted=Contatto stabilito, status_label_done=Completata, status_label_cancelled_by_provider=Annullata, status_label_cancelled_by_client=Il cliente ha annullato, status_btn_contacted=Contatto stabilito, status_btn_cancel=Annulla richiesta, status_cancelled=Annullato",
    "lb": "status_label_new=Nei, status_label_contacted=Kontakt gemaach, status_label_done=Ofgeschloss, status_label_cancelled_by_provider=Annuléiert, status_label_cancelled_by_client=De Client huet annuléiert, status_btn_contacted=Kontakt gemaach, status_btn_cancel=Ufro annuléieren, status_cancelled=Annuléiert",
    "lt": "status_label_new=Nauja, status_label_contacted=Kontaktas užmegztas, status_label_done=Baigta, status_label_cancelled_by_provider=Atšaukta, status_label_cancelled_by_client=Klientas atšaukė, status_btn_contacted=Kontaktas užmegztas, status_btn_cancel=Atšaukti užklausą, status_cancelled=Atšaukta",
    "lv": "status_label_new=Jauns, status_label_contacted=Kontakts nodibināts, status_label_done=Pabeigts, status_label_cancelled_by_provider=Atcelts, status_label_cancelled_by_client=Klients atcēla, status_btn_contacted=Kontakts nodibināts, status_btn_cancel=Atcelt pieprasījumu, status_cancelled=Atcelts",
    "mk": "status_label_new=Нова, status_label_contacted=Воспоставен контакт, status_label_done=Завршена, status_label_cancelled_by_provider=Откажана, status_label_cancelled_by_client=Клиентот откажа, status_btn_contacted=Воспоставен контакт, status_btn_cancel=Откажи барање, status_cancelled=Откажано",
    "mt": "status_label_new=Ġdida, status_label_contacted=Kuntatt magħmul, status_label_done=Lesta, status_label_cancelled_by_provider=Ikkanċellata, status_label_cancelled_by_client=Il-klijent ikkanċella, status_btn_contacted=Kuntatt magħmul, status_btn_cancel=Ikkanċella t-talba, status_cancelled=Ikkanċellat",
    "nl": "status_label_new=Nieuw, status_label_contacted=Contact gelegd, status_label_done=Voltooid, status_label_cancelled_by_provider=Geannuleerd, status_label_cancelled_by_client=Klant heeft geannuleerd, status_btn_contacted=Contact gelegd, status_btn_cancel=Verzoek annuleren, status_cancelled=Geannuleerd",
    "no": "status_label_new=Ny, status_label_contacted=Kontakt opprettet, status_label_done=Fullført, status_label_cancelled_by_provider=Avbestilt, status_label_cancelled_by_client=Kunden avbestilte, status_btn_contacted=Kontakt opprettet, status_btn_cancel=Avbryt forespørsel, status_cancelled=Kansellert",
    "pl": "status_label_new=Nowe, status_label_contacted=Nawiązano kontakt, status_label_done=Ukończone, status_label_cancelled_by_provider=Anulowane, status_label_cancelled_by_client=Klient anulował, status_btn_contacted=Nawiązano kontakt, status_btn_cancel=Anuluj zgłoszenie, status_cancelled=Anulowano",
    "pt": "status_label_new=Nova, status_label_contacted=Contato feito, status_label_done=Concluída, status_label_cancelled_by_provider=Cancelada, status_label_cancelled_by_client=O cliente cancelou, status_btn_contacted=Contato feito, status_btn_cancel=Cancelar solicitação, status_cancelled=Cancelado",
    "pt-PT": "status_label_new=Nova, status_label_contacted=Contacto feito, status_label_done=Concluída, status_label_cancelled_by_provider=Cancelada, status_label_cancelled_by_client=O cliente cancelou, status_btn_contacted=Contacto feito, status_btn_cancel=Cancelar pedido, status_cancelled=Cancelado",
    "ro": "status_label_new=Nouă, status_label_contacted=Contact stabilit, status_label_done=Finalizată, status_label_cancelled_by_provider=Anulată, status_label_cancelled_by_client=Clientul a anulat, status_btn_contacted=Contact stabilit, status_btn_cancel=Anulează cererea, status_cancelled=Anulat",
    "ru": "status_label_new=Новая, status_label_contacted=Контакт установлен, status_label_done=Завершена, status_label_cancelled_by_provider=Отменена, status_label_cancelled_by_client=Клиент отменил, status_btn_contacted=Контакт установлен, status_btn_cancel=Отменить заявку, status_cancelled=Отменено",
    "sk": "status_label_new=Nová, status_label_contacted=Kontakt nadviazaný, status_label_done=Dokončené, status_label_cancelled_by_provider=Zrušené, status_label_cancelled_by_client=Klient zrušil, status_btn_contacted=Kontakt nadviazaný, status_btn_cancel=Zrušiť požiadavku, status_cancelled=Zrušené",
    "sl": "status_label_new=Nova, status_label_contacted=Vzpostavljen stik, status_label_done=Zaključeno, status_label_cancelled_by_provider=Preklicano, status_label_cancelled_by_client=Stranka je preklicala, status_btn_contacted=Vzpostavljen stik, status_btn_cancel=Prekliči zahtevo, status_cancelled=Preklicano",
    "sq": "status_label_new=E re, status_label_contacted=Kontakti u bë, status_label_done=Përfunduar, status_label_cancelled_by_provider=Anuluar, status_label_cancelled_by_client=Klienti anuloi, status_btn_contacted=Kontakti u bë, status_btn_cancel=Anulo kërkesën, status_cancelled=Anuluar",
    "sr": "status_label_new=Нова, status_label_contacted=Контакт успостављен, status_label_done=Завршено, status_label_cancelled_by_provider=Отказано, status_label_cancelled_by_client=Клијент је отказао, status_btn_contacted=Контакт успостављен, status_btn_cancel=Откажи захтев, status_cancelled=Отказано",
    "sv": "status_label_new=Ny, status_label_contacted=Kontakt tagen, status_label_done=Klar, status_label_cancelled_by_provider=Avbokad, status_label_cancelled_by_client=Kunden avbokade, status_btn_contacted=Kontakt tagen, status_btn_cancel=Avboka förfrågan, status_cancelled=Avbokad",
    "tr": "status_label_new=Yeni, status_label_contacted=İletişim kuruldu, status_label_done=Tamamlandı, status_label_cancelled_by_provider=İptal edildi, status_label_cancelled_by_client=Müşteri iptal etti, status_btn_contacted=İletişim kuruldu, status_btn_cancel=İsteği iptal et, status_cancelled=İptal edildi",
    "uk": "status_label_new=Нова, status_label_contacted=Контакт встановлено, status_label_done=Завершено, status_label_cancelled_by_provider=Скасовано, status_label_cancelled_by_client=Клієнт скасував, status_btn_contacted=Контакт встановлено, status_btn_cancel=Скасувати заявку, status_cancelled=Скасовано",
}
