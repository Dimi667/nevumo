...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "page_title": {
        "bg":    "Общи условия за Доставчици на Услуги | Nevumo",
        "cs":    "Podmínky pro Poskytovatele Služeb | Nevumo",
        "da":    "Vilkår og betingelser for tjenesteudbydere | Nevumo",
        "de":    "Nutzungsbedingungen für Dienstleister | Nevumo",
        "el":    "Όροι και Προϋποθέσεις για Παρόχους Υπηρεσιών | Nevumo",
        "en":    "Terms & Conditions for Service Providers | Nevumo",
        "es":    "Términos y Condiciones para Proveedores de Servicios | Nevumo",
        "et":    "Teenusepakkujate tingimused | Nevumo",
        "fi":    "Palveluntarjoajien käyttöehdot | Nevumo",
        "fr":    "Conditions générales pour les Prestataires de Services | Nevumo",
        "ga":    "Téarmaí agus Coinníollacha do Sholáthróirí Seirbhíse | Nevumo",
        "hr":    "Uvjeti poslovanja za pružatelje usluga | Nevumo",
        "hu":    "Szolgáltatók felhasználási feltételei | Nevumo",
        "is":    "Skilmálar og skilyrði fyrir þjónustuaðila | Nevumo",
        "it":    "Termini e Condizioni per i Fornitori di Servizi | Nevumo",
        "lb":    "Konditiounen fir Servicepresser | Nevumo",
        "lt":    "Paslaugų teikėjų naudojimosi sąlygos | Nevumo",
        "lv":    "Pakalpojumu sniedzēju lietošanas noteikumi | Nevumo",
        "mk":    "Услови за Давачи на Услуги | Nevumo",
        "mt":    "Termini u Kundizzjonijiet għall-Fornituri tas-Servizz | Nevumo",
        "nl":    "Algemene voorwaarden voor dienstverleners | Nevumo",
        "no":    "Vilkår og betingelser for tjenesteleverandører | Nevumo",
        "pl":    "Regulamin dla Dostawców Usług | Nevumo",
        "pt":    "Termos e Condições para Prestadores de Serviços | Nevumo",
        "pt-PT": "Termos e Condições para Prestadores de Serviços | Nevumo",
        "ro":    "Termeni și condiții pentru Furnizorii de Servicii | Nevumo",
        "ru":    "Условия использования для Поставщиков Услуг | Nevumo",
        "sk":    "Podmienky pre Poskytovateľov Služieb | Nevumo",
        "sl":    "Pogoji za ponudnike storitev | Nevumo",
        "sq":    "Termat dhe Kushtet për Ofruesit e Shërbimeve | Nevumo",
        "sr":    "Услови коришћења за Пружаоце Услуга | Nevumo",
        "sv":    "Villkor för tjänsteleverantörer | Nevumo",
        "tr":    "Hizmet Sağlayıcılar için Kullanım Koşulları | Nevumo",
        "uk":    "Умови використання для Постачальників Послуг | Nevumo",
    },
    "meta_description": {
