...
<body style="font-family:Arial,sans-serif;color:#333;background-color:#ffffff;">
    <div style="max-width:600px;margin:0 auto;padding:20px;">
        ...
        <p><button onclick="navigator.clipboard.writeText('{magic_link_url}');this.textContent='Skopiowano!';setTimeout(()=>this.textContent='Kopiuj link',2000);" style="background:#f97316;color:white;padding:12px 24px;text-decoration:none;border-radius:6px;display:inline-block;border:none;cursor:pointer;">Kopiuj link</button></p>
...
<body style="font-family:Arial,sans-serif;color:#333;background-color:#ffffff;">
    <div style="max-width:600px;margin:0 auto;padding:20px;">
        ...
        <p><button onclick="navigator.clipboard.writeText('{magic_link_url}');this.textContent='Copied!';setTimeout(()=>this.textContent='Copy link',2000);" style="background:#f97316;color:white;padding:12px 24px;text-decoration:none;border-radius:6px;display:inline-block;border:none;cursor:pointer;">Copy link</button></p>
