# Nevumo — Terms & Conditions for Service Providers / Regulamin dla Dostawców Usług / Общи условия за Доставчици на Услуги

**Version / Wersja / Версия:** 1.0  
**Effective date / Data wejścia w życie / Дата на влизане в сила:** 2026-06-01  
**Company / Firma / Фирма:** „ФИЛИПС ЦЕНТЬР БЪЛГАРИЯ" ООД, ЕИК 175369610
...
**Operator:** „ФИЛИПС ЦЕНТЬР БЪЛГАРИЯ" ООД, registered in Bulgaria under EIC 175369610, with registered office at: ul. Petko Karavelov, bl. 77, entr. A, apt. 19, district Triaditza, postcode 1408, Sofia, Bulgaria ("Nevumo", "we", "us", "the Operator").  
**Contact:** legal@nevumo.com | privacy@nevumo.com
...
### 4. Provider Profile and Service Listings
...
|-----------|--------|-------------|
| Profile completeness | High | Profiles with full information, photo, and verified contact details rank higher |
| Average review score | High | Higher average rating from verified Clients improves ranking |
| Response rate and speed | Medium | Providers who respond to Leads promptly receive a higher position |
| Activity recency | Medium | Recently active profiles rank above inactive ones |
| Service geographic match | Medium | Proximity or match to the Client's city |
| Account standing | High | Accounts without warnings or restrictions rank higher |
...
6.1 The Platform is currently **free of charge** for Providers during the launch phase. The current Price List is available at nevumo.com/pricing.

6.2 Nevumo reserves the right to introduce a commission or paid features. Any such introduction will be announced with at least **30 days' written notice** sent to your registered email address before taking effect.

6.3 If Nevumo introduces payment processing for services concluded through the Platform, payments will be processed by Stripe Inc. ("Stripe") acting as a payment processor. In Poland, BLIK and Przelewy24 will be available as payment methods.

6.4 Nevumo does not hold Client funds on its own accounts. All financial intermediation is handled exclusively through Stripe.

6.5 Providers are solely responsible for issuing invoices, collecting taxes (VAT, income tax), and complying with all applicable fiscal obligations in their country of establishment and in the country where services are provided.
...
## Regulamin dla Dostawców Usług

**Operator:** „ФИЛИПС ЦЕНТЬР БЪЛГАРИЯ" ООД (Philips Center Bulgaria Ltd.), spółka z ograniczoną odpowiedzialnością zarejestrowana w Bułgarii pod numerem EIK (NIP bułgarski) 175369610, z siedzibą pod adresem: bul. Petko Karavelov, bl. 77, wejście A, mieszkanie 19, dzielnica Triadica, kod pocztowy 1408, Sofia, Bułgaria, prowadząca serwis pod marką **Nevumo** (dalej: „Nevumo", „Operator", „my").  
**Kontakt:** legal@nevumo.com | privacy@nevumo.com
...
4. Niniejszy Regulamin Dostawców stanowi wiążącą umowę pomiędzy Dostawcą a Nevumo. Dokonując rejestracji jako Dostawca, potwierdzasz, że zapoznałeś się z treścią Regulaminu Dostawców, rozumiesz go i akceptujesz go w całości.

5. Niniejszy Regulamin Dostawców stosuje się łącznie z ogólnym Regulaminem Nevumo dla Użytkowników. W przypadku sprzeczności, Regulamin Dostawców ma pierwszeństwo w zakresie relacji z Dostawcami.

6. Niniejszy Regulamin Dostawców został sporządzony zgodnie z wymogami Rozporządzenia Parlamentu Europejskiego i Rady (UE) 2019/1150 z dnia 20 czerwca 2019 r. w sprawie propagowania sprawiedliwości i przejrzystości dla użytkowników biznesowych korzystających z usług pośrednictwa internetowego (dalej: „Rozporządzenie P2B").

7. Zabrania się dostarczania przez Dostawców treści o charakterze bezprawnym.
...
1. Rejestracja na Platformie jako Dostawca jest dostępna dla:
...
2. Podczas rejestracji Dostawca obowiązany jest podać prawdziwe, pełne i aktualne informacje. Dostawca ponosi odpowiedzialność za bieżące utrzymywanie aktualności swoich danych.

3. Każdy Dostawca może posiadać wyłącznie jedno konto Dostawcy. Zakładanie wielu kont w celu obejścia ograniczeń lub zawieszeń jest zabronione.

4. Dostawca odpowiada za zachowanie poufności danych logowania do swojego konta oraz za wszelkie działania podejmowane w ramach tego konta.

5. To samo konto użytkownika może być używane jednocześnie w roli Dostawcy i Klienta. Zmiana roli nie wymaga odrębnej rejestracji.

---

### §4. Profil Dostawcy i Oferty Usług

1. Po zakończeniu rejestracji Dostawca może założyć Profil i dodawać Oferty Usług. Każda Oferta musi dokładnie opisywać oferowaną usługę, jej zakres, cenę i dostępność.

2. Dostawca zapewnia, że wszystkie informacje opublikowane na jego Profilu i w Ofertach Usług są zgodne z prawdą, dokładne i nie wprowadzają w błąd.

3. Dostawca nie może publikować treści, które:
...
4. Nevumo zastrzega sobie prawo do usunięcia lub edycji treści naruszających niniejszy Regulamin Dostawców lub obowiązujące przepisy prawa, bez uprzedniego powiadomienia.

5. **Profile Przejęte (Claimed Profiles):** Jeżeli Nevumo utworzyło wstępny profil na podstawie publicznie dostępnych informacji, Dostawca może go przejąć w drodze procesu weryfikacji. Po przejęciu Dostawca otrzyma powiadomienie zgodnie z art. 14 RODO, opisujące przechowywane dotyczące go dane osobowe i podstawę prawną ich przetwarzania.

---

### §5. Ranking i widoczność

1. Nevumo wyświetla profile Dostawców i Oferty Usług w wynikach wyszukiwania oraz w listingach kategorii. Kolejność, w jakiej Dostawcy są prezentowani („ranking"), ustalana jest na podstawie następujących parametrów:

| Parametr | Waga | Opis |
|----------|------|------|
| Kompletność profilu | Wysoka | Profile z pełnymi informacjami, zdjęciem i zweryfikowanymi danymi kontaktowymi zajmują wyższe pozycje |
| Średnia ocena opinii | Wysoka | Wyższa średnia ocena od zweryfikowanych Klientów poprawia pozycję w rankingu |
| Wskaźnik i szybkość odpowiedzi | Średnia | Dostawcy, którzy szybko odpowiadają na Zapytania, zajmują wyższą pozycję |
| Aktywność na Platformie | Średnia | Profile aktywne ostatnio mają przewagę nad nieaktywnymi |
| Dopasowanie geograficzne usługi | Średnia | Bliskość lub zgodność z miastem Klienta |
| Status konta | Wysoka | Konta bez ostrzeżeń ani ograniczeń zajmują wyższe pozycje |

2. **Płatność nie wpływa na organiczny ranking.** Nevumo nie przyjmuje płatności w zamian za poprawę pozycji w organicznych wynikach wyszukiwania.

3. W przyszłości Nevumo może oferować **płatne pozycje promocyjne** (pozycje sponsorowane). Takie pozycje będą wyraźnie oznaczone jako „Sponsorowane" lub „Promowane". O wprowadzeniu płatnych promocji Dostawcy zostaną poinformowani z wyprzedzeniem co najmniej **30 dni**.
...
1. Platforma jest obecnie dla Dostawców **bezpłatna** w fazie startowej (launch). Aktualny Cennik dostępny jest pod adresem nevumo.com/pricing.

2. Nevumo zastrzega sobie prawo do wprowadzenia prowizji lub płatnych funkcjonalności. O takim wprowadzeniu Dostawcy zostaną poinformowani z co najmniej **30-dniowym wyprzedzeniem**, w formie pisemnej (wiadomość e-mail na zarejestrowany adres), przed datą wejścia w życie zmian.

3. W przypadku wdrożenia obsługi płatności za usługi zawierane za pośrednictwem Platformy, płatności będą przetwarzane przez Stripe Inc. („Stripe") działający jako operator płatności. Dla Dostawców i Klientów w Polsce dostępne będą metody płatności **BLIK** oraz **Przelewy24**.

4. Nevumo nie przechowuje środków Klientów na własnych rachunkach. Wszelka pośrednictwo finansowe realizowane jest wyłącznie za pośrednictwem Stripe.

5. Dostawcy ponoszą wyłączną odpowiedzialność za wystawianie faktur, rozliczanie podatków (VAT, podatek dochodowy) i przestrzeganie wszystkich obowiązujących przepisów podatkowych w kraju, w którym prowadzą działalność, oraz w kraju, w którym świadczą usługi.

---

### §7. Obowiązki Dostawców

1. Dostawca zobowiązuje się:
...
### §8. Zawieszenie, ograniczenie i rozwiązanie konta

#### §8.1. Przesłanki ograniczenia lub zawieszenia

Nevumo może **ograniczyć** (np. tymczasowo ukryć Profil w wynikach wyszukiwania) lub **zawiesić** konto Dostawcy (tymczasowo zablokować dostęp) z następujących przyczyn:

a) naruszenie §7 ust. 2 (działania zabronione);  
b) podanie nieprawdziwych danych podczas rejestracji lub w Profilu;  
c) powtarzające się lub udokumentowane skargi Klientów dotyczące niewykonania lub złej jakości usług;  
d) działalność oszukańcza lub podejrzenie takiej działalności, w tym oszustwa płatnicze;  
e) brak wymaganych licencji lub zezwoleń;  
f) naruszenie praw własności intelektualnej osób trzecich;  
g) niewykonanie prawomocnego orzeczenia sądu lub decyzji organu regulacyjnego;  
h) incydenty bezpieczeństwa dotyczące Platformy lub innych użytkowników;  
i) naruszenie niniejszego Regulaminu Dostawców lub obowiązujących przepisów prawa.

#### §8.2. Przesłanki rozwiązania konta

Nevumo może **rozwiązać** (trwale zamknąć) konto Dostawcy z następujących przyczyn:

a) każda przesłanka wymieniona w §8.1, jeżeli naruszenie jest poważne lub wielokrotne;  
b) poważne naruszenie przepisów o ochronie konsumentów powodujące szkodę u Klientów;  
c) prawomocne orzeczenie sądu lub trybunału arbitrażowego stwierdzające odpowiedzialność Dostawcy za oszustwo lub działalność bezprawną;  
d) potwierdzone fałszerstwo tożsamości;  
e) dobrowolne rozwiązanie konta na żądanie Dostawcy (zob. §8.5).

#### §8.3. Wypowiedzenie z zachowaniem okresu wypowiedzenia

Tam, gdzie jest to możliwe, Nevumo powiadomi Dostawcę o zamiarze rozwiązania konta z zachowaniem **30-dniowego okresu wypowiedzenia**, za pośrednictwem wiadomości e-mail na zarejestrowany adres, ze wskazaniem przyczyny rozwiązania.

Trzydziestodniowy okres wypowiedzenia **nie obowiązuje** w następujących przypadkach:
- poważne zagrożenia bezpieczeństwa Platformy lub innych użytkowników;
- potwierdzone oszustwo lub fałszerstwo tożsamości;
- obowiązek prawny wymagający podjęcia natychmiastowych działań;
- Dostawca złożył wniosek o natychmiastowe rozwiązanie konta.

W takich przypadkach Nevumo może rozwiązać konto ze skutkiem natychmiastowym i poinformować Dostawcę tak szybko, jak będzie to możliwe.

#### §8.4. Powiadomienie o ograniczeniu lub zawieszeniu

Tam, gdzie jest to możliwe i proporcjonalne, Nevumo:
- powiadomi Dostawcę o ograniczeniu lub zawieszeniu w momencie jego zastosowania (lub niezwłocznie po nim, jeżeli wcześniejsze powiadomienie uniemożliwiłoby osiągnięcie celu danego środka);
- wskaże konkretną przyczynę (przyczyny) ograniczenia lub zawieszenia;
- zapewni Dostawcy możliwość odniesienia się do sprawy za pośrednictwem wewnętrznego systemu rozpatrywania skarg (§12).

#### §8.5. Dobrowolne rozwiązanie konta przez Dostawcę

Dostawca może w każdej chwili rozwiązać swoje konto Dostawcy, kontaktując się z nami pod adresem legal@nevumo.com lub za pośrednictwem ustawień konta. Rozwiązanie konta następuje w ciągu **14 dni** od złożenia wniosku. Dostawca pozostaje odpowiedzialny za realizację wszelkich zobowiązań podjętych wobec Klientów przed datą wejścia w życie rozwiązania.

---

### §9. Weryfikacja tożsamości (KYC) i oświadczenie o statusie przedsiębiorcy
...
### §12. Wewnętrzny system rozpatrywania skarg
...
4. Wersją wiążącą prawnie niniejszego Regulaminu Dostawców dla Dostawców z siedzibą w Polsce jest wersja **polska**.
...
## Общи условия за Доставчици на Услуги

**Оператор:** „ФИЛИПС ЦЕНТЬР БЪЛГАРИЯ" ООД, дружество с ограничена отговорност, регистрирано в Република България с ЕИК 175369610, с адрес на управление: бул. Петко Каравелов бл. 77, вх. А, ап. 19, р-н Триадица, п.к. 1408, гр. София, България, опериращо под търговската марка **Nevumo** (по-нататък: „Nevumo", „Операторът", „ние").  
**Контакт:** legal@nevumo.com | privacy@nevumo.com

---

### Чл. 1. Общи разпоредби

1. Настоящите Общи условия за Доставчици (по-нататък: „Условия за Доставчици") уреждат отношенията между Nevumo и всяко физическо или юридическо лице, регистрирано в Платформата като доставчик на услуги (по-нататък: „Доставчик").

2. Nevumo управлява онлайн платформа за посредничество при предоставяне на услуги, достъпна на адрес nevumo.com и нейните езикови поддомейни (по-нататък: „Платформата"), която дава възможност на Доставчиците да представят своите услуги и ги свързва с клиенти, търсещи такива услуги (по-нататък: „Клиенти").

3. Nevumo действа единствено като **посредник** и не е страна по никакъв договор за предоставяне на услуги, сключен между Доставчик и Клиент. Nevumo не предоставя услугите, предлагани от Доставчиците, не ги наема и не носи отговорност за качеството, обхвата или навременното изпълнение на услугите.

4. Условията за Доставчици представляват обвързващ договор между Вас и Nevumo. С извършването на регистрация като Доставчик Вие потвърждавате, че сте прочели, разбрали и приели изцяло Условията за Доставчици.
...
| Термин | Значение |
|--------|----------|
| **Платформа** | Уеб сайтът и мобилното приложение на Nevumo, достъпни на адрес nevumo.com и неговите поддомейни |
| **Доставчик** | Физическо лице на възраст поне 18 години или юридическо лице, регистрирано в Платформата за предлагане на услуги |
| **Клиент** | Физическо лице, регистрирано в Платформата за търсене и поръчване на услуги |
...
| **Комисионна** | Таксата, начислявана от Nevumo за посреднически услуги, съгласно актуалния Ценоразпис |
| **Ценоразпис** | Документът, определящ актуалните комисионни и такси, достъпен на nevumo.com/pricing |
| **Търговец** | Доставчик, действащ в качеството на лице, извършващо стопанска дейност |

---

### Чл. 3. Регистрация и акаунт

1. Регистрацията в Платформата като Доставчик е достъпна за:
...
2. При регистрацията Доставчикът е длъжен да предостави верни, пълни и актуални данни. Доставчикът носи отговорност за поддържането на актуалността на своите данни по всяко време.

3. Всеки Доставчик може да притежава само един доставчически акаунт. Забранено е създаването на множество акаунти с цел заобикаляне на ограничения или спирания.

4. Доставчикът отговаря за опазването на поверителността на своите данни за достъп и за всички действия, извършени в рамките на неговия акаунт.

5. Един и същ потребителски акаунт може да се използва едновременно в роля на Доставчик и Клиент. Промяната на роля не изисква отделна регистрация.

---

### Чл. 4. Профил и обяви за услуги

1. След завършване на регистрацията Доставчикът може да създаде Профил и да добавя Обяви за услуги. Всяка обява трябва точно да описва предлаганата услуга, нейния обхват, цена и наличност.

2. Доставчикът гарантира, че цялата информация, публикувана в неговия Профил и Обяви за услуги, е достоверна, точна и не въвежда в заблуждение.

3. Доставчикът не може да публикува съдържание, което:
   - е незаконно, обидно, дискриминационно или нарушава права на трети лица;
   - представлява спам, подвеждаща реклама или съдържа неистински отзиви;
   - се представя за друго лице или субект;
   - нарушава права на интелектуална собственост.

4. Nevumo си запазва правото да премахне или редактира всяко съдържание, нарушаващо Условията за Доставчици или приложимото законодателство, без предварително уведомление.

5. **Претендирани профили:** Ако Nevumo е създало предварителен профил въз основа на публично достъпна информация, Доставчикът може да го претендира чрез процеса на верификация. При претендиране на профила Доставчикът ще получи уведомление по чл. 14 от ОРЗД, описващо съхраняваните лични данни за него и правното основание за тяхното обработване.

---

### Чл. 5. Класиране и видимост

1. Nevumo показва профилите на Доставчиците и Обявите за услуги в резултатите от търсенето и в листингите по категории. Редът, в който Доставчиците се показват („класиране"), се определя въз основа на следните параметри:

| Параметър | Тежест | Описание |
|-----------|--------|----------|
| Пълнота на профила | Висока | Профилите с пълна информация, снимка и верифицирани данни за контакт се класират по-високо |
| Средна оценка от отзиви | Висока | По-висока средна оценка от верифицирани Клиенти подобрява класирането |
| Степен и скорост на отговор | Средна | Доставчиците, отговарящи бързо на Запитвания, заемат по-висока позиция |
| Скорошна активност | Средна | Профилите с наскорошна активност имат предимство пред неактивните |
| Географско съответствие | Средна | Близост или съвпадение с града на Клиента |
| Статус на акаунта | Висока | Акаунтите без предупреждения или ограничения се класират по-високо |

2. **Плащането не влияе на органичното класиране.** Nevumo не приема плащания срещу подобряване на позицията в органичните резултати от търсенето.
...
### Чл. 6. Комисионни, плащания и ценоразпис

1. Платформата е в момента **безплатна** за Доставчиците по време на стартовата фаза. Актуалният Ценоразпис е достъпен на nevumo.com/pricing.

2. Nevumo си запазва правото да въведе комисионна или платени функционалности. За такова въвеждане Доставчиците ще бъдат уведомявани с **поне 30 дни предизвестие** в писмена форма (имейл до регистрирания адрес), преди влизането в сила на промените.

3. При внедряване на обработка на плащания за услуги, сключвани чрез Платформата, плащанията ще се обработват от Stripe Inc. („Stripe"), действаща като оператор на плащания. За Доставчиците и Клиентите в Полша ще бъдат достъпни методите за плащане **BLIK** и **Przelewy24**.

4. Nevumo не съхранява средства на Клиентите по собствени сметки. Цялото финансово посредничество се извършва изключително чрез Stripe.

5. Доставчиците носят изцяло отговорност за издаването на фактури, изчисляването и плащането на данъци (ДДС, подоходен данък) и спазването на всички приложими данъчни задължения в страната, в която извършват дейност, и в страната, в която предоставят услуги.

---

### Чл. 7. Задължения на Доставчиците
...
### Чл. 8. Спиране, ограничаване и прекратяване на акаунт
...
В тези случаи Nevumo може да прекрати акаунта незабавно и да уведоми Доставчика веднага щом това стане разумно осъществимо.

#### Чл. 8.4. Уведомление при ограничаване или спиране

При наличие на такава възможност и когато е пропорционално, Nevumo:
- ще уведоми Доставчика за ограничаването или спирането в момента на прилагането им (или непосредствено след това, ако предварителното уведомление би осуетило целта на мярката);
- ще посочи конкретното(ите) основание(я) за ограничаването или спирането;
- ще предостави на Доставчика възможност да отговори на въпроса чрез вътрешния механизъм за разглеждане на жалби (чл. 12).

#### Чл. 8.5. Доброволно прекратяване от Доставчика

Доставчикът може по всяко време да прекрати своя доставчически акаунт, като се свърже с нас на legal@nevumo.com или чрез настройките на акаунта. Прекратяването влиза в сила в рамките на **14 дни** от подаването на заявката. Доставчикът остава отговорен за изпълнението на всички ангажименти, поети към Клиенти преди датата на влизане в сила на прекратяването.

---

### Чл. 9. Верификация (KYC) и декларация за статус на търговец
...
### Чл. 10. Изменения на Условията за Доставчици
...
### Чл. 11. Достъп до данни на Доставчика
...
### Чл. 12. Вътрешна система за разглеждане на жалби
...
### Чл. 14. Ограничаване на отговорността
...
### Чл. 15. Интелектуална собственост
