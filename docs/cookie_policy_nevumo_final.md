...
| `nevumo_city` | Cookie | Stores the city selected by the user for homepage personalisation | Nevumo | 1 year | Functional | Legitimate Interest |
...
| `nevumo_city` | Cookie | Przechowuje miasto wybrane przez użytkownika do personalizacji strony głównej | Nevumo | 1 rok | Funkcjonalne | Uzasadniony interes |
...
| `nevumo_city` | Бисквитка | Съхранява избрания от потребителя град за персонализация на началната страница | Nevumo | 1 година | Функционални | Легитимен интерес |
