...
- **cookies namespace (May 16, 2026)**: Cookie Policy page translations
  ...
  - Total: 40 keys × 34 languages + 12 keys (EN only table data) + 4 keys × 34 languages (browser paths) = 1,360 + 12 + 136 = 1,508 rows
  - Seed scripts: seed_cookies_p21.py (374 rows), seed_cookies_p22.py (306 rows), seed_cookies_p23.py (272 rows), seed_cookies_p24.py (408 rows), seed_cookies_table_data_p1.py (23 rows), seed_cookies_browser_paths_p2.py (68 rows), seed_cookies_browser_paths_p3.py (68 rows)
